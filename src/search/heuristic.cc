...
bool Heuristic::is_using() {
  return !(stop_using);
}

void Heuristic::evaluate(const State &state) {
    /*  if(Current_RIDA_Phase==SOLVING_PHASE){
     cout<<"starting evaluating heuristic"<<endl;fflush(stdout);
    }*/
    //cout<<"starting evaluating heuristic"<<endl;fflush(stdout);
    if(stop_using){
      //cout<<"stop_using"<<endl;fflush(stdout);
      heuristic = 0;
    ...
    if (heuristic == NOT_INITIALIZED){
      //cout<<"calling initialize"<<endl;fflush(stdout);
        initialize();
      //cout<<"initialize finished"<<endl;fflush(stdout);
    }
    preferred_operators.clear();
    //cout<<"compute_heuristic"<<endl;fflush(stdout);
    heuristic = 0;
    heuristic = compute_heuristic(state);
    /*  if(Current_RIDA_Phase==SOLVING_PHASE){
      cout<<"heuristic value:"<<heuristic<<endl;fflush(stdout);
    }*/
    ...
    evaluator_value = heuristic;
    /*  if(Current_RIDA_Phase==SOLVING_PHASE){
      cout<<"finished evaluating heuristic "<<get_heur_name()<<endl;fflush(stdout);
    }*/
}
