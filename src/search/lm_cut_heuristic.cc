...
void LandmarkCutHeuristic::first_exploration(const State &state) {
	...
	cout<<"\t\tStarting first_exploration:"<<endl;fflush(stdout);
      }*/
    assert(priority_queue.empty());
      /*  if(Current_RIDA_Phase==SOLVING_PHASE){
	cout<<"\t\tStarting setup_exploration:"<<endl;fflush(stdout);
      }*/
    setup_exploration_queue();
      /*  if(Current_RIDA_Phase==SOLVING_PHASE){
	cout<<"\t\tExploration_queue finised:"<<endl;fflush(stdout);
      }*/
    setup_exploration_queue_state(state);
        /*  if(Current_RIDA_Phase==SOLVING_PHASE){
	cout<<"\t\tExploration_queue_state finished:"<<endl;fflush(stdout);
      }*/
    while (!priority_queue.empty()) {
      /*  if(Current_RIDA_Phase==SOLVING_PHASE){
	cout<<"\t\tWorking on Priority queue:"<<endl;fflush(stdout);
      }*/
      ...
      /*  if(Current_RIDA_Phase==SOLVING_PHASE){
	cout<<"\t\tWorking on triggered_operator:"<<i<<endl;fflush(stdout);
      }*/
            RelaxedOperator *relaxed_op = triggered_operators[i];
	    /* `if(relaxed_op==NULL){
	      cout<<"relaxed_op is null!!!"<<endl;fflush(stdout);
	    }*/
        ...
        /*  if(Current_RIDA_Phase==SOLVING_PHASE){
	cout<<"\t\tFinished with first exploration:"<<endl;fflush(stdout);
      }*/
}
...
int LandmarkCutHeuristic::compute_heuristic(const State &state) {
    /*if(Current_RIDA_Phase==SOLVING_PHASE){
      cout<<"\tstarting lmcut_compute_heuristic"<<endl;fflush(stdout);
    }*/
    reset_operator_costs(state);
    /*  if(Current_RIDA_Phase==SOLVING_PHASE){
      cout<<"operators reseted"<<endl;fflush(stdout);
    }*/
    // TODO: Possibly put back in some kind of preferred operator mechanism.
    /*  for (int i = 0; i < relaxed_operators.size(); i++) {
        RelaxedOperator &op = relaxed_operators[i];
    ...
    /*  if(Current_RIDA_Phase==SOLVING_PHASE){
      cout<<"calling first exploration"<<endl;fflush(stdout);
    }*/
    first_exploration(state);
    /*  if(Current_RIDA_Phase==SOLVING_PHASE){
      cout<<"finished first exploration"<<endl;fflush(stdout);
    }*/
