...
TypeSampler::TypeSampler(Heuristic* heuristic)
{
...
void TypeSampler::sample(State state, int parent_heuristic, TypeChildren& type_children, int type, int current_level)
{
...
Type TypeSampler::getType(State state, int h, int type)
{
