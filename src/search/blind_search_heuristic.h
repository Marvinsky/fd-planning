...
public:
    ...
    virtual void print_heur_name() {cout<<",heur:blind";}
    virtual string get_heur_name() {string temp="blind()";return temp;}
    virtual string get_heur_call_name() {string temp="blind()";return temp;}
