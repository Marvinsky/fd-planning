...
#echo "skipping"
    if [ "$i" -lt "10" ]
    then
      nohup ./timeout -t 1800 ./planRAStar benchmarks/woodworking-opt11-strips/domain.pddl benchmarks/woodworking-opt11-strips/p0$((i)).pddl >& logs_IPC2011/log_RA_51h_32bits_NewDemote2ndSub_WOODWORKING_$((i)) &
    else
      nohup ./timeout -t 1800 ./planRAStar benchmarks/woodworking-opt11-strips/domain.pddl benchmarks/woodworking-opt11-strips/p$((i)).pddl >& logs_IPC2011/log_RA_51h_32bits_NewDemote2ndSub_WOODWORKING_$((i)) &
    fi
    elif [ "$i" -lt "61" ]
    then
    if [ "$i" -lt "40" ]
