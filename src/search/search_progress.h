...
public:
    ...
    void reset_for_new_iter() {expanded_states=0;generated_states=0;evaluated_states=0;generated_ops=0;pathmax_corrections=0;evaluations=0;dead_end_states=0;}
