#ifndef EAGER_COLL_SEARCH_H
#define EAGER_COLL_SEARCH_H
...
class EagerCollSearch : public SearchEngine {
...
public:
    EagerCollSearch(const Options &opts);
    ...
    void generateReport();
    int returnMaxLevel(vector<int> levels);
};
