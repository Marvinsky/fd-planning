...
public:
    ...
    void dump_fdr() const;
    void dump() const {dump_fdr();};
    void inline_dump() const ;
    ...
    void get_state_id_string(string *state_id) const;
    void gen_next_state(const State &predecessor, const Operator &op);
};
